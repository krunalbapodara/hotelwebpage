...
const ImageSlider = ({ obj = {} }) => { // takes in images as props
    ...
    return (
        <div>
            {obj.images.length > 0 && <div className="sliderContainer">
                <img className="imgStyle" src={obj.images[index]} alt={index} />
            ...
            <div className="details">
                <div className="flexLine">
                    <span className="confortTitle">{obj.name}</span>
                    {obj.images.length > 0 && <span>{`${index + 1}/${obj.images.length}`}</span>}
                </div>
